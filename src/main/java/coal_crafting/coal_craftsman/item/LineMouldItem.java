...
public class LineMouldItem extends CoalCraftsmanModElements.ModElement {
	@ObjectHolder("coal_craftsman:line_mould")
	public static final Item block = null;
	public LineMouldItem(CoalCraftsmanModElements instance) {
		super(instance, 7);
	}
