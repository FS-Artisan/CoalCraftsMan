...
public class CarbonPlateItem extends CoalCraftsmanModElements.ModElement {
	@ObjectHolder("coal_craftsman:carbon_plate")
	public static final Item block = null;
	public CarbonPlateItem(CoalCraftsmanModElements instance) {
		super(instance, 6);
	}
