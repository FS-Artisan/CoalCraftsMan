...
public class OilStringItem extends CoalCraftsmanModElements.ModElement {
	@ObjectHolder("coal_craftsman:oil_string")
	public static final Item block = null;
	public OilStringItem(CoalCraftsmanModElements instance) {
		super(instance, 5);
	}
