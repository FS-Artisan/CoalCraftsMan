...
public class RedSandLineMouldItem extends CoalCraftsmanModElements.ModElement {
	@ObjectHolder("coal_craftsman:red_sand_line_mould")
	public static final Item block = null;
	public RedSandLineMouldItem(CoalCraftsmanModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("red_sand_line_mould");
		}
